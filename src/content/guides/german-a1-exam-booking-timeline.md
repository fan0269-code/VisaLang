...
description: "Plan your German A1 exam booking timeline for Germany family reunion: exam seat, result timing, certificate delivery, retake buffer, and document deadline."
category: "germany-a1"
...
Do not assume an available seat solves the problem. Check result timing, certificate delivery, and whether the authority accepts later submission.
...
Do not start with booking. Use the A1 decision helper and requirement guide first, then choose an accepted exam path.

## Next action

Write down your document deadline, planned exam date, expected result date, and backup date. Then use the Goethe A1 fee-check workflow and German A1 documents checklist before paying.
...
Last updated: 2026-07-08. Official sources last checked: 2026-07-08.
