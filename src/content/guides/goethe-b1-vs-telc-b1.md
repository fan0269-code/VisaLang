---
title: "DTZ vs Goethe B1 vs telc B1: verify acceptance before choosing"
description: "A safe decision page for DTZ, Goethe-Zertifikat B1 and telc Deutsch B1: ask the competent authority first, then compare exam products and official centres."
category: "germany-b1"
...
| --- | --- | --- |
| [BAMF: final examination and certificate](https://www.bamf.de/EN/Themen/Integration/ZugewanderteTeilnehmende/Integrationskurse/Abschlusspruefung/abschlusspruefung-node.html) | DTZ is the language test at the end of the integration course; results can show A2 or B1, and the integration-course certificate combines B1 DTZ with the Life in Germany test. | Whether a DTZ result is accepted for your exact settlement-permit, citizenship, work, or other route. |
| [BAMF: naturalisation](https://www.bamf.de/EN/Themen/Integration/ZugewanderteTeilnehmende/Einbuergerung/einbuergerung-node.html) | BAMF describes naturalisation-related integration tests and mentions B1-level DTZ in that context. | Your local naturalisation authority's document list, wider eligibility, appointment procedure, or acceptance of non-DTZ certificates. |
| [Goethe-Institut: German examinations](https://www.goethe.de/en/spr/prf.html) | Goethe lists German exams by CEFR level and describes B1 exam products. | Whether your authority accepts Goethe-Zertifikat B1, how old the certificate may be, or which modules must be shown. |
| [Goethe-Institut Germany: Goethe-Zertifikat B1](https://www.goethe.de/ins/de/en/prf/prf/gzb1.html) | Goethe-Zertifikat B1 certifies B1-level German skills under the CEFR scale. | Local authority acceptance, exam seat availability, fees, result timing, or immigration outcome. |
| [telc: Zertifikat Deutsch / telc Deutsch B1](https://www.telc.net/en/language-examinations/certificate-exams/german/certificate-german-telc-german-b1/) | telc Deutsch B1 is a general German examination at CEFR level B1. | Whether the receiving authority accepts this exact telc product or a specific result document for your route. |
| [telc: find an examination centre](https://www.telc.net/en/language-examinations/find-a-telc-examination-centre/) | telc directs candidates to examination centres for dates and local information. | A guaranteed date, price, result timeline, retake rule, or authority acceptance. |
