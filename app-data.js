(function (root, factory) {
  ...
  const i18n = {
    en: {
      ...
      heroHeadline: "Find the right language exam for your visa, residency, citizenship, or work path",
      heroCopy:
        "Official-first guides for Goethe, IELTS, TOEFL, DELF, CILS, DELE, YKI and more.",
      heroSearchLabel: "Search country, exam, or visa route",
      heroSearchPlaceholder: "Search country, exam, or visa route",
      ...
      guideMetric: "high-trust guides",
      routeMetric: "exam-route clusters",
      countryMetric: "country pathways",
      ...
      startByTitle: "Start from the way you think",
      startByHint: "Country, exam, or goal — each path leads back to official sources.",
      startCountry: "Start with your country",
      startCountryText: "Germany, UK, Canada, Italy, Netherlands, Portugal, Finland, and more.",
      startExam: "Start with your exam",
      startExamText: "Goethe, IELTS, LanguageCert, CILS, DELE, YKI, TEF, TCF and more.",
      startGoal: "Start with your goal",
      startGoalText: "Visa, residency, citizenship, study, or professional registration.",
      ...
      routeUpdatesText:
        "Tell us your route and stage so we can prioritize the most useful official-source updates.",
      joinWaitlist: "Join waitlist",
      emailPlaceholder: "you@example.com",
      routeGermanyA1: "Germany A1 family reunion",
      routeGermanyB1: "Germany B1 settlement/work",
      routeUkSelt: "UK SELT visa English",
      routeCanadaFrench: "Canada TEF/TCF French",
      routeNotSure: "Not sure yet",
      stageChecking: "Checking requirement",
      stageChoosing: "Choosing exam",
      stageBooking: "Booking soon",
      stagePreparing: "Already preparing",
      waitlistSending: "Sending…",
      waitlistSuccess: "Thanks! We saved your route interest locally for this demo. Connect an email service before launch.",
    ...
    zh: {
      ...
      heroHeadline: "根据签证、永居、入籍、留学或职业注册需求，找到正确的语言考试路径",
      heroCopy:
        "覆盖 Goethe、IELTS、TOEFL、DELF、CILS、DELE、YKI 等考试，优先回到官方来源核验。",
      heroSearchLabel: "搜索国家、考试或签证路径",
      heroSearchPlaceholder: "搜索国家、考试或签证路径",
      startRoute: "从你的路径开始",
      browseExams: "浏览考试库",
      startHere: "从这里开始",
      threeFields: "3 项信息",
      ...
      sourceGroups: "组官方来源",
      startByTitle: "按你的理解方式开始",
      startByHint: "可以先选国家、考试，也可以先选目标；每条路径都会回到官方来源。",
      startCountry: "从国家开始",
      startCountryText: "德国、英国、加拿大、意大利、荷兰、葡萄牙、芬兰等。",
      startExam: "从考试开始",
      startExamText: "Goethe、IELTS、LanguageCert、CILS、DELE、YKI、TEF、TCF 等。",
      startGoal: "从目标开始",
      startGoalText: "签证、永居、入籍、留学或职业注册。",
      costTitle: "总费用计算器",
      ...
      routeUpdatesText: "告诉我们你的路线和阶段，我们会优先更新最有用的官方来源信息。",
      joinWaitlist: "加入等待名单",
      emailPlaceholder: "you@example.com",
      routeGermanyA1: "德国 A1 家庭团聚",
      routeGermanyB1: "德国 B1 永居/工作",
      routeUkSelt: "英国 SELT 签证英语",
      routeCanadaFrench: "加拿大 TEF/TCF 法语",
      routeNotSure: "还不确定",
      stageChecking: "正在确认要求",
      stageChoosing: "正在选择考试",
      stageBooking: "准备报名",
      stagePreparing: "已经开始备考",
      waitlistSending: "发送中…",
      waitlistSuccess: "感谢加入！当前演示版已记录你的路线意向；正式上线前请接入邮件服务。",
